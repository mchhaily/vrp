...
if (!host) {
    if (location.port === '') {
        ...
        host = location.protocol + '//' + location.hostname + ":" + location.port + '/VehicleRouting';
    }
}
...
var routingLayer;
var map;
var browserTitle = "Routing Vehicles on Map";
